...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'Тема письма - TEST',
		'title' => 'Заголовок в теле письма',
		'ajax' => true,
		'validate' => true,
		'from_email' => 'testnoreply@email.com',
		'from_name' => 'Imya',
		'to_email' => 'olegzigu@gmail.com',
		'to_name' => 'olegu',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
...
$form['form-2'] = array(
    ...
    'cfg' => array(
        'charset' => 'utf-8',
        'subject' => 'Заявка с сайта andreynikitin.pro',
        'title' => 'Поступила заявка с сайта',
        'ajax' => true,
        'validate' => true,
        'from_email' => 'noreply@email.com',
        'from_name' => 'andreynikitin.pro',
        'to_email' => 'adbeam.agency@gmail.com',
        'to_name' => 'Андрею',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
