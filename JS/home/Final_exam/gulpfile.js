...
gulp.task('html:build', function () {
    gulp.src(path.src.html)                // Выберем файлы по нужному пути
        ...
        .pipe(gulp.dest(path.build.html))  // Результат отправим в папку build
...
gulp.task('image:build', function () {
    gulp.src(path.src.img)                          // Выберем наши картинки
        ...
        .pipe(gulp.dest(path.build.img))            // Отправляем в build
});
...
gulp.task('clean', function (cb) {   // При запуске этой команды будет удаляться папка build и после этого можем заново запустить сборку папки build
